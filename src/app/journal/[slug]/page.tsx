...
const articles: Record<string, Article> = {
  "why-sovereign-ai": {
    ...
    paragraphs: [
      { type: "p", content: "Pakistan stands at a critical juncture. With 240 million people — the world's 6th largest population — and 64% of its citizens under 30 (UNDP), the country has an extraordinary demographic advantage. Yet it has zero sovereign AI models." },
      ...
      { type: "p", content: "Pakistan has everything it needs except infrastructure and investment. Over 36,500 CS graduates from accredited universities every year. A diaspora at Google, Meta, OpenAI. That's Zahin." },
    ],
  },
  "fine-tuning-gemma-pakistani-languages": {
    ...
    paragraphs: [
      ...
      { type: "ul", content: "", items: ["Urdu — 230M+ speakers (L1+L2, globally), some NLP resources", "Punjabi — 113M+ speakers, almost no AI coverage", "Pashto — 60M+ speakers, minimal coverage", "Sindhi — 30M+ speakers, zero AI coverage", "Balochi — 8M+ speakers, zero AI coverage"] },
